...
class MassConvertOperations{
	...
	async massConvert(request)	{
		const Convert = (await (import("./convert.js"))).MasterModel;
		if((request != null) && (!(request instanceof Convert)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: request EXPECTED TYPE: Convert", null, null);
		}
