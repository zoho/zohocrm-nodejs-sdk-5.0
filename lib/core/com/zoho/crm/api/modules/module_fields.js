...
class ModuleFields extends Fields{
	 ...
	 * @returns {ModuleFieldLookup} An instance of ModuleFieldLookup
	 */
	getLookup()	{
		return this.lookup;
	...
	async setLookup(lookup)	{
		const ModuleFieldLookup = (await (import("./module_field_lookup.js"))).MasterModel;
		if((lookup != null) && (!(lookup instanceof ModuleFieldLookup)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: lookup EXPECTED TYPE: ModuleFieldLookup", null, null);
		}
		this.lookup = lookup;
