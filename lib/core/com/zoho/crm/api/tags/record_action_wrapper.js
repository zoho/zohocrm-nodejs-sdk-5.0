...
class RecordActionWrapper{
	 ...
	 * @returns {Boolean} A Boolean representing the lockedCount
	 */
	getLockedCount()	{
	 ...
	 * @param {Boolean} lockedCount A Boolean representing the lockedCount
	 */
	setLockedCount(lockedCount)	{
		if((lockedCount != null) && (!(Object.prototype.toString.call(lockedCount) == "[object Boolean]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: lockedCount EXPECTED TYPE: Boolean", null, null);
		}
