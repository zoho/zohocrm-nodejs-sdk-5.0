...
class TagsOperations{
	 ...
	 * @throws {SDKException}
	 */
	async addTags(recordId, module, request, paramInstance=null)	{
	 ...
	 * @throws {SDKException}
	 */
	async removeTags(recordId, module, request)	{
	 ...
	 * @throws {SDKException}
	 */
	async addTagsToMultipleRecords(module, request, paramInstance=null)	{
		const NewTagRequestWrapper = (await (import("./new_tag_request_wrapper.js"))).MasterModel;
		if((!(Object.prototype.toString.call(module) == "[object String]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: module EXPECTED TYPE: String", null, null);
		}
	 ...
	 * @throws {SDKException}
	 */
	async removeTagsFromMultipleRecords(module, request, paramInstance=null)	{
		const ExistingTagRequestWrapper = (await (import("./existing_tag_request_wrapper.js"))).MasterModel;
		if((!(Object.prototype.toString.call(module) == "[object String]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: module EXPECTED TYPE: String", null, null);
		}
