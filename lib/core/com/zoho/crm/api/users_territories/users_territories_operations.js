...
class UsersTerritoriesOperations{
	 ...
	 * @throws {SDKException}
	 */
	async getTerritoriesOfUser(user)	{
	 ...
	 * @throws {SDKException}
	 */
	async associateTerritoriesToUser(user, request)	{
	 ...
	 * @throws {SDKException}
	 */
	async getTerritoryOfUser(territory, user)	{
	 ...
	 * @throws {SDKException}
	 */
	async validateBeforeTransferForAllTerritories(user)	{
		if((!(Object.prototype.toString.call(user) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: user EXPECTED TYPE: BigInt", null, null);
		}
		var handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws {SDKException}
	 */
	async validateBeforeTransfer(territory, user)	{
		if((!(Object.prototype.toString.call(territory) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: territory EXPECTED TYPE: BigInt", null, null);
		}
		if((!(Object.prototype.toString.call(user) == "[object BigInt]")))	{
	 ...
	 * @throws {SDKException}
	 */
	async delinkAndTransferFromAllTerritories(user, request)	{
	 ...
	 * @throws {SDKException}
	 */
	async delinkAndTransferFromSpecificTerritory(territory, user, request)	{
		const TransferWrapper = (await (import("./transfer_wrapper.js"))).MasterModel;
		if((!(Object.prototype.toString.call(territory) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: territory EXPECTED TYPE: BigInt", null, null);
		}
