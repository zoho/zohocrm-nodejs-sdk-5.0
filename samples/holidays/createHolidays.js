...
class CreateHolidays
{
    ...
    {
        let holidaysOperations = new ZOHOCRMSDK.Holidays.HolidaysOperations("440240020813n");
        ...
        shifthour.setId(4402481394758n);
        ...
        let response =await holidaysOperations.createHolidays(request);
        if (response != null)
        {
