...
class ChangeOwner
{
    ...
    {
        let massChangeOwnerOperations = new ZOHOCRMSDK.ChangeMassOwner.MassChangeOwnerOperations();
        let bodyWrapper = new ZOHOCRMSDK.ChangeMassOwner.BodyWrapper();
        bodyWrapper.setCvid(440248001996n);
        ...
        let response = await massChangeOwnerOperations.changeOwner(moduleAPIName, bodyWrapper);
        if (response != null)
        {
