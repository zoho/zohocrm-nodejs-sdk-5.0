...
class User{
	 ...
	 * @returns {ComposeSettings} An instance of ComposeSettings
	 */
	getComposeSettings()	{
	 ...
	 */
	async setComposeSettings(composeSettings)	{
		const ComposeSettings = (await (import("./compose_settings.js"))).MasterModel;
		if((composeSettings != null) && (!(composeSettings instanceof ComposeSettings)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: composeSettings EXPECTED TYPE: ComposeSettings", null, null);
		}
