...
class UploadAttachments{
    ...
    static async uploadAttachments(moduleAPIName, recordId, absoluteFilePath) {
        ...
        let response = await attachmentsOperations.createAttachment(recordId, moduleAPIName, fileBodyWrapper);
        if (response != null) {
...
let recordId = 4402480774074n;
let absoluteFilePath = "/users/file.txt";
