...
class GetModule
{
    ...
    static async getModule(recordId, module)
    {
        let entityScoresOperations = new ZOHOCRMSDK.EntityScores.EntityScoresOperations("Positive_Score");
        let response = await entityScoresOperations.getModule(recordId, module);
        if(response != null)
        {
...
let recordId = 44024800262315n;
let module = "Leads";
await GetModule.initialize();
await GetModule.getModule(recordId, module);