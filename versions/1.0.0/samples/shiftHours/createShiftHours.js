...
class CreateShiftHours
{
    ...
    {
        let shiftHoursOerations = new ZOHOCRMSDK.HoursShift.ShiftHoursOperations("4400020813");
        ...
        let shiftDays = [];
        shiftDays.push(new ZOHOCRMSDK.Choice("Monday"));
        shiftDays.push(new ZOHOCRMSDK.Choice("Tuesday"));
        ...
        breakDays.push(new ZOHOCRMSDK.Choice("Tuesday"));
