...
class GetUsersOfUserType
{
    ...
    {
        let userTypeUsersOperations = new ZOHOCRMSDK.TypeUserUsers.UserTypeUsersOperations();
        let paraminstance = new ZOHOCRMSDK.ParameterMap();
        await paraminstance.add(ZOHOCRMSDK.TypeUserUsers.GetUsersofUserTypeParam.TYPE, "AllUsers");
        let response = await userTypeUsersOperations.getUsersOfUserType(userTypeId, portalName, paraminstance);
        if (response != null)
        {
