...
class AppointmentPreference{
	...
	setWhenDurationExceeds(whenDurationExceeds)	{
		if((whenDurationExceeds != null) && (!(whenDurationExceeds instanceof Choice)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: whenDurationExceeds EXPECTED TYPE: Choice", null, null);
		}
	 ...
	 * @returns {Map} A Map representing the dealRecordConfiguration
	 */
	 ...
	 * @param {Map} dealRecordConfiguration A Map representing the dealRecordConfiguration
	 */
	setDealRecordConfiguration(dealRecordConfiguration)	{
		if((dealRecordConfiguration != null) && (!(Object.prototype.toString.call(dealRecordConfiguration) == "[object Map]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: dealRecordConfiguration EXPECTED TYPE: Map", null, null);
		}
