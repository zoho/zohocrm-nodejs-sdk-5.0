...
class AssignmentRules{
	 ...
	 * @returns {CreatedBy} An instance of CreatedBy
	 */
	getModifiedBy()	{
	...
	async setModifiedBy(modifiedBy)	{
		const CreatedBy = (await (import("./created_by.js"))).MasterModel;
		if((modifiedBy != null) && (!(modifiedBy instanceof CreatedBy)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: modifiedBy EXPECTED TYPE: CreatedBy", null, null);
		}
	...
	async setCreatedBy(createdBy)	{
		const CreatedBy = (await (import("./created_by.js"))).MasterModel;
		if((createdBy != null) && (!(createdBy instanceof CreatedBy)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: createdBy EXPECTED TYPE: CreatedBy", null, null);
		}
