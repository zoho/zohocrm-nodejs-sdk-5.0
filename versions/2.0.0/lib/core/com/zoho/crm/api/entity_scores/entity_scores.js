...
class EntityScores{
	 ...
	 * @returns {EntityStructureGroup} An instance of EntityStructureGroup
	 */
	getEntity()	{
		return this.entity;
	 ...
	 * @returns {ScoringRuleStructure} An instance of ScoringRuleStructure
	 */
	getScoringRule()	{
	...
	async setScoringRule(scoringRule)	{
		const ScoringRuleStructure = (await (import("./scoring_rule_structure.js"))).MasterModel;
		if((scoringRule != null) && (!(scoringRule instanceof ScoringRuleStructure)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: scoringRule EXPECTED TYPE: ScoringRuleStructure", null, null);
		}
