...
class Modules{
	...
	async setCustomView(customView)	{
		const CustomView = (await (import("../custom_views/custom_view.js"))).MasterModel;
	 ...
	 * @returns {Array} An Array representing the arguments32
	 */
	getArguments32()	{
	 ...
	 * @param {Array} arguments32 An Array representing the arguments32
	 */
	setArguments32(arguments32)	{
		if((arguments32 != null) && (!(Object.prototype.toString.call(arguments32) == "[object Array]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: arguments32 EXPECTED TYPE: Array", null, null);
		}
