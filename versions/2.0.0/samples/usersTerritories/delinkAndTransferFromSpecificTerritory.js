...
class DelinkAndTransferFromSpecificTerritory
{
    ...
    {
        let userTerritoriesOperations = new ZOHOCRMSDK.TerritoriesUsers.UsersTerritoriesOperations();
        ...
        let response = userTerritoriesOperations.delinkAndTransferFromSpecificTerritory(territoryId, userId, request);
        if (response != null)
        {
