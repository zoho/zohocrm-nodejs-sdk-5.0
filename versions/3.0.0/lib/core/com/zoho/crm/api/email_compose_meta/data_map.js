...
class DataMap{
	 ...
	 */
	async setDefaultFrom(defaultFrom)	{
		const DefaultForm = (await (import("./default_form.js"))).MasterModel;
		if((defaultFrom != null) && (!(defaultFrom instanceof DefaultForm)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: defaultFrom EXPECTED TYPE: DefaultForm", null, null);
		}
