...
class ResponseWrapper{
	 ...
	 * @returns {Array} An Array representing the info
	 */
	getInfo()	{
		return this.info;
	 ...
	 * @param {Array} info An Array representing the info
	 */
	setInfo(info)	{
		if((info != null) && (!(Object.prototype.toString.call(info) == "[object Array]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: info EXPECTED TYPE: Array", null, null);
		}
		this.info = info;
