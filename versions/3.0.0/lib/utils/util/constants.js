class Constants {
    ...
    static OAUTH_TOKEN_FIELDS = ["clientID", "clientSecret","refreshToken", "redirectURL", "grantToken", "accessToken", "expiresIn", "userSignature", "id"];
    ...
    static SET_TO_CONTENT_TYPE = ["/crm/bulk/v5/read", "/crm/bulk/v5/write"];
    ...
    static US_DATACENTER = ["https://www.zohoapis.com", "https://sandbox.zohoapis.com", "https://developer.zohoapis.com",
        "https://accounts.zoho.com/oauth/v2/token", "us"]

    static JP_DATACENTER = ["https://www.zohoapis.jp", "https://sandbox.zohoapis.jp", "https://developer.zohoapis.jp",
        "https://accounts.zoho.jp/oauth/v2/token", "jp"]

    static IN_DATACENTER = ["https://www.zohoapis.in", "https://sandbox.zohoapis.in", "https://developer.zohoapis.in",
        "https://accounts.zoho.in/oauth/v2/token", "in"]

    static EU_DATACENTER = ["https://www.zohoapis.eu", "https://sandbox.zohoapis.eu", "https://developer.zohoapis.eu",
        "https://accounts.zoho.eu/oauth/v2/token", "eu"]

    static CN_DATACENTER = ["https://www.zohoapis.com.cn", "https://sandbox.zohoapis.com.cn",
        "https://developer.zohoapis.com.cn", "https://accounts.zoho.com.cn/oauth/v2/token", "cn"]

    static AU_DATACENTER = ["https://www.zohoapis.com.au", "https://sandbox.zohoapis.com.au",
